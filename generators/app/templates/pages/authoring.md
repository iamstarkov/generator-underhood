...
расистские или ксенофобские шутки не привествуются в [@<%= underhoodName %>][uh].

Если вы заметили нарушение, как можно скорее [напишите письмо][coc-violations].

[uh]: https://twitter.com/<%= underhoodName %>
[proposal]: mailto:<%= curatorEmail %>?subject=Author’s%20proposal%20for%20@<%= underhoodName %>
[coc-violations]: mailto:<%= curatorEmail %>?subject=CoC%20violations%20in%20@<%= underhoodName %>
